...
RTTI_BEGIN_CLASS(nap::TestResource)
    ...
    RTTI_PROPERTY("Vec2", &nap::TestResource::mVec2, nap::rtti::EPropertyMetaData::Default)
    RTTI_PROPERTY("Vec3", &nap::TestResource::mVec3, nap::rtti::EPropertyMetaData::Default)
RTTI_END_CLASS
